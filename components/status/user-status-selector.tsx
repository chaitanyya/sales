...
import { updateLeadUserStatus, updatePersonUserStatus } from "@/app/actions/status";
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild disabled={isPending}>
        <button
          className={cn(
            "flex items-center gap-2 px-2 py-1 border border-white/10 bg-white/2 hover:bg-white/4 transition-colors text-sm ring-none focus:ring-0 outline-none",
