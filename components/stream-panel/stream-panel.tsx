...
export function StreamPanel() {
  ...
  return (
    <div className="border-t border-white/10 bg-black flex flex-col h-full">
      {/* Header with tabs and controls */}
      <div className="flex items-center justify-between border-b border-white/5 h-9 shrink-0">
