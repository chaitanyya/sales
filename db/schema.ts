...
export const leads = sqliteTable("leads", {
  ...
  userStatus: text("user_status", {
    enum: ["new", "qualified", "contacted", "meeting", "proposal", "negotiating", "won", "lost", "on_hold"],
  }).default("new"),
...
export const people = sqliteTable("people", {
  ...
  userStatus: text("user_status", {
    enum: ["new", "reached_out", "responded", "meeting_scheduled", "in_conversation", "champion", "not_interested"],
  }).default("new"),
