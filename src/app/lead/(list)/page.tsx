...
import { getLeadsWithScores } from "@/lib/tauri/commands";
...
export default function LeadListPage() {
  ...
  const fetchLeads = useCallback(async () => {
    try {
      const data = await getLeadsWithScores();
      setLeads(data);
    } catch (error) {
  ...
  return (
    <>
      ...
      <LeadListWithSelection groupedLeads={groupedLeads} onRefresh={fetchLeads} />
    </>
  );
}
