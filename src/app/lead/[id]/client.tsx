...
import type { Lead, Person, LeadScore, AdjacentResult } from "@/lib/tauri/types";
...
export default function LeadDetailClient() {
  ...
  const [adjacentLeads, setAdjacentLeads] = useState<AdjacentResult | null>(null);
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      setLoading(true);
      const [leadData, peopleData, scoreData, adjacentData] = await Promise.all([
        getLead(leadId),
